...
(function() {
  (function($, window, document) {
    ...
    Plugin = (function() {
      ...
      Plugin.prototype.init = function() {
        ...
        this.get_edit_tab().addClass('active');
        this.get_tab_lis().on('click', (function(_this) {
          return function(e) {
            _this.get_tab_lis().removeClass('active');
            $(e.currentTarget).addClass('active');
            return _this.$element.attr('data-show', $(e.currentTarget).data('command'));
          };
        })(this));
        return this.get_preview_tab().on('click', (function(_this) {
          return function(e) {
            return $.ajax({
              context: _this.element,
              type: 'POST',
              url: _this.$element.attr('data-preview-path'),
              data: {
                _method: 'PUT',
                text: _this.get_textarea().val() || '',
                options: _this.get_textarea_options()
              },
              success: function(html) {
                return _this.get_preview_div().html(html) || ("<p>" + (_this.get_nothing_to_preview_text()) + "</p>");
              }
            });
          };
        })(this));
      ...
      Plugin.prototype.get_textarea = function() {
        return this.get_editor_div().find('textarea');
      };

      Plugin.prototype.get_preview_div = function() {
        return this.$element.find('div.preview');
      };

      Plugin.prototype.get_editor_div = function() {
        return this.$element.find('div.editor');
      };

      Plugin.prototype.get_header = function() {
        return this.$element.find('div.header:first');
      };

      Plugin.prototype.get_tabs_ul = function() {
        return this.get_header().find('ul.tabs');
      };

      Plugin.prototype.get_tab_lis = function() {
        return this.get_tabs_ul().children('li');
      };

      Plugin.prototype.get_preview_tab = function() {
        return this.get_tab_lis().filter('.preview');
      };

      Plugin.prototype.get_edit_tab = function() {
        return this.get_tab_lis().filter('.edit');
      };

      Plugin.prototype.get_nothing_to_preview_text = function() {
        return this.get_preview_div().data('nothing-to-preview-text') || "Nothing to preview.";
      };

      Plugin.prototype.get_textarea_options = function() {
  ...
  $(function() {
    return $('div.simple_form_markdown_editor').simple_form_markdown_editor_tabs();
  });
...
(function() {
  (function($, window, document) {
    ...
    defaults = {
      debug: false,
      definitions: JSON.parse('{"strong":"**%{str}**","em":"*%{str}*","code":"`%{str}`","hr":"%{str}***","ul":"* %{str}","ol":"1. %{str}","blockquote":"\u003e %{str}","h1":"# %{str}","h2":"## %{str}","h3":"### %{str}","h4":"#### %{str}","h5":"##### %{str}","h6":"###### %{str}","a":"[%{str}](|)","img":"![%{str}](|)"}')
    };
    Plugin = (function() {
      function Plugin(element, options) {
        this.element = element;
      ...
      Plugin.prototype.init = function() {
        ...
        if (this.help_is_visible()) {
          this.get_help_button().addClass('active');
        }
        this.get_help_button().on('click', (function(_this) {
          return function(e) {
            $(e.currentTarget).toggleClass('active');
            return _this.toggle_help_visibility();
          };
        })(this));
        return this.get_command_buttons().on('click', (function(_this) {
          return function(e) {
            var $btn, cmd;
            $btn = $(e.currentTarget);
            cmd = $btn.attr('value');
            return _this.execute_command(cmd);
          };
        })(this));
      };

      Plugin.prototype.get_textarea = function() {
        return this.get_editor_div().children('textarea');
      };

      Plugin.prototype.get_editor_div = function() {
        return this.$element.children('div.editor');
      };

      Plugin.prototype.get_header_div = function() {
        return this.$element.children('div.header:first');
      };

      Plugin.prototype.get_help_div = function() {
        return this.$element.children('div.help');
      };

      Plugin.prototype.get_button_groups_ul = function() {
        return this.get_header_div().find('ul.button_groups');
      };

      Plugin.prototype.get_button_group_lis = function() {
        return this.get_button_groups_ul().children('li.button_group');
      };

      Plugin.prototype.get_buttons_uls = function() {
        return this.get_button_group_lis().children('ul.buttons');
      };

      Plugin.prototype.get_button_lis = function() {
        return this.get_buttons_uls().children('li.button');
      };

      Plugin.prototype.get_buttons = function() {
        return this.get_button_lis().children('button');
      };

      Plugin.prototype.get_command_buttons = function() {
        return this.get_buttons().not(this.get_help_button());
      };

      Plugin.prototype.get_help_button = function() {
        return this.get_buttons().filter('.help');
      };

      Plugin.prototype.help_is_visible = function() {
        return this.get_help_div().attr('data-visible') === 'true';
      };

      Plugin.prototype.execute_command = function(cmd) {
        var $textarea, caret_pos, definition, end, replacement, selection, start;
        $textarea = this.get_textarea();
        selection = this.get_selection($textarea);
        definition = this.settings.definitions[cmd];
        ...
        this.replace_selection($textarea, replacement);
        return this.set_selection($textarea, start, end);
      };

      Plugin.prototype.get_selection = function($e) {
        return {
      ...
      Plugin.prototype.set_selection = function($e, start, end) {
        $e.focus();
        $e[0].selectionStart = start;
        return $e[0].selectionEnd = end;
      };

      Plugin.prototype.replace_selection = function($e, string) {
        var end, start, val;
        start = $e[0].selectionStart;
        end = $e[0].selectionEnd;
        val = $e.val();
      ...
      Plugin.prototype.toggle_help_visibility = function() {
        return this.get_help_div().attr('data-visible', String(!this.help_is_visible()));
      };
  ...
  $(function() {
    return $('div.simple_form_markdown_editor').simple_form_markdown_editor_buttons();
  });
...
(function() {
  (function($, window, document) {
    ...
    Plugin = (function() {
      ...
      Plugin.prototype.init = function() {
        ...
        this.set_section_li(this.get_section_lis().first());
        this.get_section_lis().on('click', (function(_this) {
          return function(e) {
            var $li;
            $li = $(e.currentTarget);
            return _this.set_section_li($li);
          };
        })(this));
        return this.get_sub_section_lis().on('click', (function(_this) {
          return function(e) {
            var $li;
            $li = $(e.currentTarget);
            return _this.set_sub_section_li($li);
          };
        })(this));
      };

      Plugin.prototype.get_help_div = function() {
        return this.$element.find('div.help');
      };

      Plugin.prototype.get_sections_ul = function() {
        return this.get_help_div().find('ul.sections');
      };

      Plugin.prototype.get_section_lis = function() {
        return this.get_sections_ul().children('li');
      };

      Plugin.prototype.get_sub_section_ul = function(section) {
        return this.get_sub_sections_uls().filter("." + section);
      };

      Plugin.prototype.get_sub_sections_uls = function() {
        return this.get_help_div().find('ul.sub_sections');
      };

      Plugin.prototype.get_sub_section_lis = function() {
        return this.get_sub_sections_uls().children('li.sub_section');
      };

      Plugin.prototype.get_help_text_divs = function() {
        return this.get_help_div().find('div.help_text');
      };

      Plugin.prototype.set_section_li = function($li) {
        var $sub_section_ul, section;
        $li.siblings('li').removeClass('active');
        $li.addClass('active');
        section = $li.data('toggle');
        $sub_section_ul = this.get_sub_section_ul(section);
        return this.set_sub_section_ul($sub_section_ul);
      };

      Plugin.prototype.set_sub_section_ul = function($ul) {
        var $li;
        $ul.siblings('ul').removeClass('active');
        $ul.addClass('active');
        $li = $ul.children('li:first');
        return this.set_sub_section_li($li);
      };

      Plugin.prototype.set_sub_section_li = function($li) {
        var $help_text_div;
        $li.siblings('li').removeClass('active');
        $li.addClass('active');
        $help_text_div = this.get_help_text_divs().filter("." + ($li.data('toggle')));
        return this.set_help_text_div($help_text_div);
      };

      Plugin.prototype.set_help_text_div = function($div) {
  ...
  $(function() {
    return $('div.simple_form_markdown_editor').simple_form_markdown_editor_help();
  });
