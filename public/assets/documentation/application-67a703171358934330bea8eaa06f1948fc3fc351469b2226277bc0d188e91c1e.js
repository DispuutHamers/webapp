...
(function() {
  $(function() {
    var openUploadDialog;
    $('form.pageForm textarea').autosize({
      append: '\n\n'
    });
    ...
    $('.js-screenshot').on('click', function(e) {
      e.preventDefault();
      return openUploadDialog();
    });
    $('.edit-article').on('drop', function(e) {
      var file;
      e.stopPropagation();
      e.preventDefault();
      file = e.originalEvent.dataTransfer.files[0];
      return openUploadDialog(file);
    });
    return openUploadDialog = function(file) {
      var caretPosition, content, contentArea, editForm, uploadFormUrl;
      ...
      if (file != null) {
        uploadFormUrl = uploadFormUrl + ("?filename=" + file.name);
      }
      return Nifty.Dialog.open({
        ...
        afterLoad: function(dialog) {
          ...
          return dialog.on('submit', 'form', function(e) {
            var fileExt, filename, formData;
            form = $(this);
            ...
            $.ajax({
              ...
              success: function(data) {
                var newCaretPosition, newContent, screenshotLink;
