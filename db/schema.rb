...
ActiveRecord::Schema[6.1].define(version: 20_230_826_135_442) do
  ...
  create_table 'drafts', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[entity_type entity_id], name: 'index_drafts_on_entity_type_and_entity_id'
  end
  ...
  create_table 'groups', force: :cascade do |t|
    ...
    t.index %w[user_id group_id], name: 'index_groups_on_user_id_and_group_id', unique: true
  ...
  create_table 'quotes', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_quotes_on_user_id_and_created_at'
  end
  ...
  create_table 'reviews', force: :cascade do |t|
    ...
    t.index %w[user_id beer_id], name: 'index_reviews_on_user_id_and_beer_id', unique: true
  end
