...
Usergroup.create!(id: 12, name: 'O-Lid', description: 'In deze groep zitten alle oude leden van de vereniging, zodat ze de juisten rechten hebben.').logo.attach(io: File.open('test/fixtures/active_storage/user_groups/oudjes.png'), filename: 'oudjes.png', content_type: 'image/png')
